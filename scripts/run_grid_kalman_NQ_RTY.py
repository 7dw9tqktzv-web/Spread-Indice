...
def main():
    ...
    log.info("  NOTE: No OLS baseline for NQ_RTY (OLS tested and found non-viable)")
...
def generate_reports(df: pd.DataFrame):
    ...
    log.info(f"\n{'='*130}")
    log.info(" NQ_RTY GRID SEARCH (no OLS baseline -- OLS tested and found non-viable for this pair)")
